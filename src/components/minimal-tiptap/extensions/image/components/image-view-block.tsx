...
import {
  ...
  ActionWrapper,
  ImageActions,
} from "@/components/minimal-tiptap/extensions/image/components/image-actions";
import { ImageOverlay } from "@/components/minimal-tiptap/extensions/image/components/image-overlay";
import { ResizeHandle } from "@/components/minimal-tiptap/extensions/image/components/resize-handle";
import type { ElementDimensions } from "@/components/minimal-tiptap/extensions/image/hooks/use-drag-resize";
import { useDragResize } from "@/components/minimal-tiptap/extensions/image/hooks/use-drag-resize";
import { useImageActions } from "@/components/minimal-tiptap/extensions/image/hooks/use-image-actions";
import type { UploadReturnType } from "@/components/minimal-tiptap/extensions/image/image";
import { blobUrlToBase64, randomId } from "@/components/minimal-tiptap/utils";
